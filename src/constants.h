...
// CÁMARA
// =========================
const float HEIGHT_EYE = 2.0f; // Altura del ojo para la cámara (altura promedio de una persona)
...
const float WALL_THICKNESS = 0.30f;
...
const float FLASHLIGHT_INNER_ANGLE = 15.0f;
const float FLASHLIGHT_OUTER_ANGLE = 45.0f;

// =========================
// PERSONAJE
// =========================
const float CHARACTER_INITIAL_Y = 0.5f;

const glm::vec3 HEAD_POSITION = glm::vec3(0.0f, 1.60f, 0.0f);
const glm::vec3 HEAD_SCALE = glm::vec3(0.52f, 0.62f, 0.52f);

const glm::vec3 TORSO_POSITION = glm::vec3(0.0f, 0.85f, 0.0f);
const glm::vec3 TORSO_SCALE = glm::vec3(0.75f, 1.00f, 0.40f);
